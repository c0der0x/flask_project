...
flask_app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:////vagrant/blog.db"
flask_app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = False  # Odstráni varovanie
...
print("Používaná databáza:", flask_app.config["SQLALCHEMY_DATABASE_URI"])